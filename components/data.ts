const serviceData = [
  {
    ...
    "Outcome": "Clear, reliable inputs for decision-making backed by verified ground data."
  },

  {
    ...
    "Outcome": "Early visibility of issues and clear direction for timely action."
  },

  {
    ...
    "Outcome": "Enhanced strategic positioning and improved electoral performance."
  },

  {
    ...
    intro: "Communication and image management services help parties and candidates build and maintain a strong public presence.",
    "How We Work": "We begin by understanding the client's public image, communication objectives, audiences, and existing perception. Our teams develop consistent messaging across media, digital platforms, and public communication. We monitor reactions and media narratives, identify potential reputation risks, and adapt communication plans to maintain credibility and strengthen public engagement.",
    "Key Work Areas": [
    ...
    "Outcome": "Enhanced public perception and improved media coverage."
  },

  {
    ...
    intro: "Market research and business insights services provide data-driven intelligence to inform strategic decision-making.",
    "How We Work": "We start by defining the business question and identifying the information required to address it. Our researchers combine primary surveys, consumer interactions, secondary research, and market data to understand customer behaviour and competition. The findings are validated, analyzed, and translated into practical insights that support business and growth decisions.",
    "Key Work Areas": [
    ...
    "Outcome": "Informed strategic decisions and improved business performance."
  },

  {
    ...
    "Outcome": "Improved project outcomes and enhanced organizational governance."
  }
];